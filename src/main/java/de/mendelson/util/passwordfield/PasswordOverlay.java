...
public class PasswordOverlay {
    ...
    private static final MendelsonMultiResolutionImage IMAGE_EYE_MASKED
            = MendelsonMultiResolutionImage.fromSVG("/util/passwordfield/password_toggle.svg", 16,
                    48);
    private static final MendelsonMultiResolutionImage IMAGE_EYE_UNMASKED
            = MendelsonMultiResolutionImage.fromSVG("/util/passwordfield/password_toggle_nomask.svg", 16,
                    48);
